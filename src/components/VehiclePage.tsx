...
const VehiclePage: React.FC<VehiclePageProps> = ({ vehicle }) => {
  ...
  const handleContactDealer = () => {
    // Contact dealer logic
    console.log('Contacting dealer:', vehicle.dealer.name);
  };

  const handleTestDrive = () => {
    // Schedule test drive logic
    console.log('Scheduling test drive for vehicle:', vehicle.id);
  };

  const handleFinanceInquiry = () => {
    // Finance inquiry logic
    console.log('Finance inquiry for vehicle:', vehicle.id);
  };
