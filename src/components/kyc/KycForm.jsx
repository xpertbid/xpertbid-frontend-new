...
const KycForm = ({ kycType, documentId, onSuccess, onCancel }) => {
    ...
    <div className="kyc-form">
      ...
      <form onSubmit={handleSubmit}>
                  ...
                  <div key={type} className="col-md-6 col-lg-4 mb-3">
                    ...
                    >
                      <div className="card-body text-center">
                        <div className="mb-2">
                          {type === 'user' && <i className="f-user fa-2x text-primary"></i>}
                          {type === 'vendor' && <i className="f-store fa-2x text-primary"></i>}
                          {type === 'property' && <i className="f-home fa-2x text-primary"></i>}
                          {type === 'vehicle' && <i className="f-car fa-2x text-primary"></i>}
                          {type === 'auction' && <i className="f-gavel fa-2x text-primary"></i>}
                        </div>
        ...
        <div className="card mb-4">
          <div className="card-header">
            <h6 className="mb-0">
              <i className="f-file-upload me-2"></i>
          ...
          <div className="card-body">
            <div className="mb-3">
              ...
              <div className="form-text">
                Supported formats, PNG, PDF, DOC, DOCX (Max 10MB per file)
              </div>
            </div>
