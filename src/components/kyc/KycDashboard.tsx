                ...
                return (
                  <div key={type} className="col-md-6 col-lg-4 mb-3">
                    ...
                    >
                      <div className="card-body text-center">
                        <div className="mb-3">
                          {type === 'user' && <i className="fas fa-user fa-3x text-primary"></i>}
                          {type === 'vendor' && <i className="fas fa-store fa-3x text-primary"></i>}
                          {type === 'property' && <i className="fas fa-home fa-3x text-primary"></i>}
                          {type === 'vehicle' && <i className="fas fa-car fa-3x text-primary"></i>}
                          {type === 'auction' && <i className="fas fa-gavel fa-3x text-primary"></i>}
                        </div>
      ...
      {documents.length === 0 && !isLoading && (
        <div className="card">
          <div className="card-body text-center py-5">
            <i className="fas fa-id-card fa-4x text-muted mb-3"></i>
