...
import { Vendor, VendorStats, Order, Product } from '@/types';
        ...
        <div className="container py-5">
          <div className="text-center">
            <div className="alert alert-warning" role="alert">
              ...
              <p>You don&apos;t have a vendor account yet. Would you like to register as a vendor?</p>
        ...
        <div className="container py-4">
            ...
            <div className="dashboard-overview">
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="dashboard-card">
                    <div className="card-header">
                      <h6><i className="fas fa-exclamation-triangle me-2"></i>Low Stock</h6>
                    </div>
                    <div className="card-body">
                      {dashboardData?.low_stock_products?.length ? (
                        <div className="low-stock-items">
                          {dashboardData.low_stock_products.map((product: Product) => (
          ...
          {activeTab === 'analytics' && (
            <div className="dashboard-analytics">
              <div className="dashboard-card">
                <div className="card-header">
                  <h5><i className="fas fa-chart-line me-2"></i>Analytics & Reports</h5>
                </div>
                <div className="card-body">
                  <div className="text-center py-5">
