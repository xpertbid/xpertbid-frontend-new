...
type ProfileTab = 'dashboard' | 'orders' | 'downloads' | 'addresses' | 'account-details' | 'waitlist' | 'wishlist';
            ...
            <div className="col-md-6 text-center">
              <div className="card">
                <div className="card-body py-5">
                  <i className="fas fa-user-circle fa-5x text-muted mb-4"></i>
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'downloads':
        return (
          <div className="text-center py-5">
            <i className="fas fa-download fa-3x text-muted mb-3"></i>
