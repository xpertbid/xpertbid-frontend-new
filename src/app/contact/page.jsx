              ...
              <div className="col-lg-6 text-center">
                <div className="success-card p-5">
                  <div className="success-icon mb-4">
                    <i className="f-check-circle fa-4x text-success"></i>
                  </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        Send Message
                        <i className="f-paper-plane ms-2"></i>
                      </>
                    )}
                  </button>
                </form>
                ...
                <div className="quick-contact-section">
                  ...
                  <div className="quick-contact-item mb-3">
                    <div className="d-flex align-items-center">
                      <i className="f-phone text-primary me-3"></i>
                      <div>
                  ...
                  <div className="quick-contact-item mb-3">
                    <div className="d-flex align-items-center">
                      <i className="f-envelope text-primary me-3"></i>
                      <div>
                  ...
                  <div className="quick-contact-item">
                    <div className="d-flex align-items-center">
                      <i className="f-comments text-primary me-3"></i>
                      <div>
