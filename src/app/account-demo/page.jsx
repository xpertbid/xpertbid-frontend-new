...
const AccountDemoPage = () => {
  ...
  const userRoles = [
    ...
    },
    {
      id: 'bidder',
      name: 'Auction Bidder',
      description: 'User who participates in auctions ',
      icon: 'f-gavel',
      color: 'warning'
    },
    {
      ...
      <div className="account-demo-page">
        <div className="container py-4">
                    ...
                    <div className="card-body text-center">
                      ...
                      {selectedRole === role.id && (
                        <div className="selected-indicator">
                          <i className="f-check-circle text-primary"></i>
          ...
          <div className="account-preview">
            <MyAccountPage user={sampleUsers[selectedRole]} />
          </div>
        </div>
      </div>
