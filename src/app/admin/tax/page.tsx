              ...
              <div className="row">
                <div className="col-md-3 mb-3">
                  <a href="/admin/tax/classes" className="btn btn-outline-primary w-100">
                    <i className="fas fa-layer-group fa-2x d-block mb-2"></i>
                    Tax Classes
                  </a>
                </div>
                <div className="col-md-3 mb-3">
                  <a href="/admin/tax/rates" className="btn btn-outline-success w-100">
                    <i className="fas fa-percentage fa-2x d-block mb-2"></i>
                    Tax Rates
                  </a>
                </div>
                <div className="col-md-3 mb-3">
                  <button className="btn btn-outline-info w-100">
                    <i className="fas fa-calculator fa-2x d-block mb-2"></i>
                    Tax Calculator
                  </button>
                </div>
                <div className="col-md-3 mb-3">
                  <button className="btn btn-outline-warning w-100">
                    <i className="fas fa-file-export fa-2x d-block mb-2"></i>
                    Tax Reports
                  </button>
                </div>
              </div>
            ...
            <div className="card-body">
              <div className="table-responsive">
                <table className="table table-sm">
                  ...
                  <tbody>
                    <tr>
                      <td><i className="fas fa-flag-usa me-1"></i>United States</td>
                      <td>8.00%</td>
                      <td><span className="badge bg-info">Sales Tax</span></td>
                    </tr>
                    <tr>
                      <td><i className="fas fa-flag me-1"></i>United Kingdom</td>
                      <td>20.00%</td>
                      <td><span className="badge bg-success">VAT</span></td>
                    </tr>
                    <tr>
                      <td><i className="fas fa-flag me-1"></i>Germany</td>
                      <td>19.00%</td>
                      <td><span className="badge bg-success">VAT</span></td>
                    </tr>
                    <tr>
                      <td><i className="fas fa-flag me-1"></i>France</td>
                      <td>20.00%</td>
                      <td><span className="badge bg-success">VAT</span></td>
                    </tr>
                    <tr>
                      <td><i className="fas fa-flag me-1"></i>Australia</td>
                      <td>10.00%</td>
                      <td><span className="badge bg-warning">GST</span></td>
                    </tr>
                    <tr>
                      <td><i className="fas fa-flag me-1"></i>Canada</td>
                      <td>5.00%</td>
                      <td><span className="badge bg-warning">GST</span></td>
                    </tr>
                  </tbody>
