            ...
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                ...
                <div className="col-auto">
                  <i className="f-handshake fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card border-left-success shadow h-100 py-2">
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                ...
                <div className="col-auto">
                  <i className="f-coins fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card border-left-info shadow h-100 py-2">
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                ...
                <div className="col-auto">
                  <i className="f-users fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card border-left-warning shadow h-100 py-2">
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                ...
                <div className="col-auto">
                  <i className="f-chart-line fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-md-3 mb-3">
                  <a href="/admin/affiliate/programs" className="btn btn-outline-primary w-100">
                    <i className="f-project-diagram fa-2x d-block mb-2"></i>
                    Programs
                  </a>
                </div>
                <div className="col-md-3 mb-3">
                  <a href="/admin/affiliate/commissions" className="btn btn-outline-success w-100">
                    <i className="f-coins fa-2x d-block mb-2"></i>
                    Commissions
                  </a>
                </div>
                <div className="col-md-3 mb-3">
                  <a href="/admin/affiliate/withdrawals" className="btn btn-outline-warning w-100">
                    <i className="f-money-bill-wave fa-2x d-block mb-2"></i>
                    Withdrawals
                  </a>
                </div>
                <div className="col-md-3 mb-3">
                  <button className="btn btn-outline-info w-100">
                    <i className="f-chart-bar fa-2x d-block mb-2"></i>
                    Reports
                  </button>
                </div>
              </div>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <i className="f-user-circle me-2"></i>
                          <div>
