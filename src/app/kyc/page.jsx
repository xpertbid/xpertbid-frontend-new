            ...
            <div className="col-lg-10">
              ...
              <div className="kyc-header text-center mb-5">
                <h1 className="display-5 fw-bold text-primary mb-3">
                  <i className="f-shield-alt me-3"></i>
              ...
              {existingDocuments.length > 0 && (
                <div className="alert alert-info mb-4">
                  <h5><i className="f-info-circle me-2"></i>Your KYC Status</h5>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="card">
                      <div className="card-header">
                        <h5><i className="f-user me-2"></i>Personal Information</h5>
                      </div>
                    ...
                    {selectedType === 'vendor' && (
                      <div className="card mt-4">
                        <div className="card-header">
                          <h5><i className="f-building me-2"></i>Business Information</h5>
                        </div>
                        <div className="card-body">
                          <div className="row">
                            <div className="col-md-6 mb-3">
                    ...
                    {selectedType === 'property' && (
                      <div className="card mt-4">
                        <div className="card-header">
                          <h5><i className="f-home me-2"></i>Property Information</h5>
                        </div>
                        <div className="card-body">
                          <div className="row">
                            <div className="col-md-6 mb-3">
                    ...
                    {selectedType === 'vehicle' && (
                      <div className="card mt-4">
                        <div className="card-header">
                          <h5><i className="f-car me-2"></i>Vehicle Information</h5>
                        </div>
                        <div className="card-body">
                          <div className="row">
                            <div className="col-md-6 mb-3">
                    ...
                    {selectedType === 'auction' && (
                      <div className="card mt-4">
                        <div className="card-header">
                          <h5><i className="f-gavel me-2"></i>Auction Item Information</h5>
                        </div>
                        <div className="card-body">
                          <div className="row">
                            <div className="col-md-6 mb-3">
                    ...
                    <div className="card mt-4">
                      <div className="card-header">
                        <h5><i className="f-upload me-2"></i>Document Upload</h5>
                      </div>
                      <div className="card-body">
                        <div className="mb-3">
                          ...
                          <div className="form-text">
                            Accepted formats, JPG, PNG, DOC, DOCX. Max file size: 10MB each.
                          </div>
                        </div>
                          ...
                          <ul className="list-unstyled">
                            {kycTypes[selectedType]?.required_documents.map((doc, index) => (
                              <li key={index} className="mb-1">
                                <i className="f-check-circle text-success me-2"></i>
                                {doc}
                              </li>
                            ))}
                          </ul>
                    ...
                    <div className="card mt-4">
                      <div className="card-header">
                        <h5><i className="f-info-circle me-2"></i>Additional Information</h5>
                      </div>
                      <div className="card-body">
                        <div className="mb-3">
