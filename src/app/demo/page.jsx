...
const DemoPage = () => {
  ...
  const sampleAuction = {
    ...
    watchers: 156,
    previousBids: [
      { id: '1', bidder: 'Collector_123', amount: 8200, timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString() },
      { id: '2', bidder: 'WatchLover', amount: 8000, timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString() },
      { id: '3', bidder: 'VintageFan', amount: 7800, timestamp: new Date(Date.now() - 6 * 60 * 60 * 1000).toISOString() }
    ]
  };
