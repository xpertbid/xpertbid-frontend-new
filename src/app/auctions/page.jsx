    ...
    const fetchAuctions = async () => {
      try {
        ...
        if (auctionsResponse.success) {
          ...
          const categories = [...new Set(auctionsData.map(a => a.category_name).filter((name)=> Boolean(name)))];
          ...
          <div className="col-lg-9">
            ...
            {currentAuctions.length === 0 ? (
              <div className="text-center py-5">
                <div className="mb-4">
                  <i className="f-gavel fa-3x text-muted"></i>
                </div>
                            ...
                            <div className="auction-image-wrapper flex-shrink-0">
                              <div className="auction-image">
                                ...
                                <div className={`auction-status ${status}`}>
                                  {status === 'ended' ? 'Ended' : status === 'ending-soon' ? 'Ending Soon' : status === 'ending-today' ? 'Ending Today' : 'Live'}
                                </div>
                              </div>
                            </div>
